...
pub fn setup_file_logger() -> Result<Option<FileLoggerGuard>, AppError> {
    setup().context("Error setting up logger")
}

fn setup() -> Result<Option<FileLoggerGuard>, Box<dyn std::error::Error>> {
